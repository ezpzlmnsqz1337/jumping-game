...
export const createStage1 = (scene: BABYLON.Scene, level: GameLevel) => {
  ...
  walls.push(
    ...
    new WallEntity(
      ...
      level,
      'box',
      { width: 2, depth: 2, height: 1.6 },
      new BABYLON.Vector3(-3, 0.8, -2)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 2, depth: 2, height: 2.2 },
    ...
    new WallEntity(
      ...
      level,
      'box',
      { width: 2, depth: 2, height: 4.6 },
      new BABYLON.Vector3(3, 2.3, 1)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 2, depth: 2, height: 5.2 },
      new BABYLON.Vector3(3, 2.6, -2)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 2, depth: 2, height: 5.8 },
      new BABYLON.Vector3(3, 2.9, -5)
    )
  );

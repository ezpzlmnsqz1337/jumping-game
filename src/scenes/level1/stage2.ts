...
export const createStage2 = (scene: BABYLON.Scene, level: GameLevel) => {
  ...
  walls.push(
    ...
    new WallEntity(
      ...
      level,
      'box',
      { width: 10, depth: 10, height: 5.8 },
      new BABYLON.Vector3(10, 2.9, -2)
    ),
    ...
    new WallEntity(
      ...
      level,
      'box',
      { width: 0.2, depth: 0.3, height: 0.5 },
      new BABYLON.Vector3(7.4, 6, 0)
    ),
    new WallEntity(
      scene,
      level,
      ...
      new BABYLON.Vector3(8, 6.3, 0)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 1, depth: 1, height: 1.6 },
      new BABYLON.Vector3(8, 6.6, -2)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 1, depth: 1, height: 2.2 },
      new BABYLON.Vector3(8, 6.9, -4)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 1, depth: 1, height: 2.8 },
      new BABYLON.Vector3(10, 7.2, -4)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 1, depth: 1, height: 3.4 },
      new BABYLON.Vector3(10, 7.5, -2)
    ),
    new WallEntity(
      scene,
      level,
      ...
      new BABYLON.Vector3(10, 7.8, 0)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 1, depth: 1, height: 4.6 },
      new BABYLON.Vector3(12, 8.1, 0)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 1, depth: 1, height: 5.2 },
      new BABYLON.Vector3(12, 8.4, -2)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 1, depth: 1, height: 5.8 },
      new BABYLON.Vector3(12, 8.7, -4)
    )
  );
  ...
  const trigger = new Trigger(scene, {
    ...
    triggerType: 'camera',
    cameraTarget: {
      alpha: stage2Camera1.alpha,
      beta: stage2Camera1.beta,
      radius: stage2Camera1.radius,
      speed: 50,
    },

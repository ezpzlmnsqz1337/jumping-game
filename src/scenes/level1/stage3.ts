...
export const stage3Camera3: ArcRotateCameraOptions = {
  position: new BABYLON.Vector3(5.1, 17.0, -12.0),
  alpha: 6.3692,
  beta: 1.1284,
  radius: 6,
};
...
export const createStage3 = (scene: BABYLON.Scene, level: GameLevel) => {
  ...
  walls.push(
    ...
    new WallEntity(
      ...
      level,
      'box',
      { width: 10, depth: 10, height: 12 },
      new BABYLON.Vector3(10, 6, -12)
    ),
    // side walls
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.2, depth: 10, height: 10 },
      new BABYLON.Vector3(14.9, 17, -12)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.2, depth: 10, height: 10 },
      new BABYLON.Vector3(5.1, 17, -12)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 9.6, depth: 0.2, height: 10 },
      new BABYLON.Vector3(10, 17, -16.9)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 9.6, depth: 0.2, height: 5 },
      new BABYLON.Vector3(10, 19.5, -7.1)
    ),
    // jumps
    // left side
    new WallEntity(
      ...
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(14.4, 12.7, -8)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(14.4, 13.1, -10)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(14.4, 13.6, -12)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(14.4, 14, -14.5)
    ),
    // back side
    new WallEntity(
      scene,
      ...
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(13, 14.7, -16.4)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(11, 15.1, -16.4)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(9, 15.6, -16.4)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(6.5, 16.3, -16.4)
    ),
    // right side
    new WallEntity(
      scene,
      ...
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(5.5, 17, -14.5)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(5.5, 17.5, -12)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(5.5, 18.1, -10)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(5.5, 18.7, -8)
    ),
    // front side
    new WallEntity(
      scene,
      ...
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(7.5, 19.1, -7.6)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.3, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(9.3, 19.6, -7.6)
    ),
    new WallEntity(
      scene,
      level,
    ...
    new WallEntity(
      ...
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(13, 20.5, -7.6)
    ),
    // left side
    new WallEntity(
      scene,
      ...
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(14.4, 21, -10)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 0.8, depth: 0.8, height: 0.2 },
      new BABYLON.Vector3(14.4, 21.4, -13)
    ),
    new WallEntity(
      scene,
      level,
      'box',
      { width: 5.8, depth: 0.5, height: 0.2 },
      new BABYLON.Vector3(8.1, 21.4, -13)
    )
  );
  ...
  const trigger1 = new Trigger(scene, {
    ...
    triggerType: 'camera',
    cameraTarget: {
      alpha: stage3Camera1.alpha,
      beta: stage3Camera1.beta,
      radius: stage3Camera1.radius,
      speed: 50,
    },
  ...
  const trigger2 = new Trigger(scene, {
    ...
    triggerType: 'camera',
    cameraTarget: {
      alpha: stage3Camera2.alpha,
      beta: stage3Camera2.beta,
      radius: stage3Camera2.radius,
      speed: 50,
    },
  ...
  const trigger4 = new Trigger(scene, {
    ...
    triggerType: 'camera',
    cameraTarget: {
      alpha: stage3Camera3.alpha,
      beta: stage3Camera3.beta,
      radius: stage3Camera3.radius,
      speed: 50,
    },
  ...
  const trigger5 = new Trigger(scene, {
    ...
    triggerType: 'camera',
    cameraTarget: {
      alpha: stage3Camera4.alpha,
      beta: stage3Camera4.beta,
      radius: stage3Camera4.radius,
      speed: 50,
    },
  ...
  const trigger6 = new Trigger(scene, {
    ...
    triggerType: 'camera',
    cameraTarget: {
      alpha: stage3Camera5.alpha,
      beta: stage3Camera5.beta,
      radius: stage3Camera5.radius,
      speed: 50,
    },
  ...
  const trigger7 = new Trigger(scene, {
    ...
    triggerType: 'camera',
    cameraTarget: {
      alpha: stage3Camera6.alpha,
      beta: stage3Camera6.beta,
      radius: stage3Camera6.radius,
      speed: 50,
    },
